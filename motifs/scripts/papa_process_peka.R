...
dbrn_paths <- list.files(path = "data/peka_papa/2023-12-15_papa_cryptics_kmer6_window_250_distal_window_500_relpos_0",
...
write_tsv(dbrn_tbl,
          "processed/peka/papa/2023-12_15_papa_cryptics_kmer6_window_250_distal_window_500_relpos_0.cleaned_6mer_distribution_genome.tsv",
          col_names = T)

write_tsv(simp_dbrn_tbl,
          "processed/peka/papa/2023-12-15_papa_cryptics_kmer6_window_250_distal_window_500_relpos_0.cleaned_6mer_distribution_genome_simple.tsv",
          col_names = T)