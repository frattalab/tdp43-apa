...
plot_kmer_dbrn <- function(plot_df, rolling_mean = F, rolling_k = 5, facet_w = "~ label", title = "", subtitle = "", n_row = 2, n_col = 1, base_size = 14, breaks = seq(-150, 150, 20), plot_colours = c("#1b9e77", "#7570b3"), facet_scales = "free_y") {
