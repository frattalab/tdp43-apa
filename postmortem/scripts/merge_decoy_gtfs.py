...
if __name__ == "__main__":
    ...
    parser.add_argument("--cryptic_3exts", required=True, help="Path to the GTF file containing 3'Exts.")
    parser.add_argument("--cryptic_prox3exts", required=True, help="Path to the GTF file containing proximal 3'Exts.")
    parser.add_argument("--cryptic_complex", required=True, help="Path to the GTF file containing 'complex' cryptic events.")
