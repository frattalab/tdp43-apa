...
# standard heatmaps
ggsave("2024-11-21_liu_facs_cryptic_median_delta_05_facet.std_event_types.png",
...
ggsave("2024-11-21_liu_facs_cryptic_median_delta_05_facet.std_event_types.svg",
       plot = median5_std_events_heatmap,
        path = "processed/liu_facs",
        height = 10,
        width = 15,
...
ggsave("2024-11-21_liu_facs_cryptic_median_delta_05_facet.std_event_types.pdf",
       plot = median5_std_events_heatmap,
        path = "processed/liu_facs",
        height = 10,
        width = 15,
